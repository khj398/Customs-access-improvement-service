/* =========================================================
   ...
   - collector 3종(BUSINESS/PERSONAL/GENERAL) 반영
...
ALTER TABLE auction
  ADD COLUMN IF NOT EXISTS collector_source VARCHAR(20) NULL COMMENT '수집 출처(GENERAL/BUSINESS/PERSONAL)' AFTER cargo_tpcd;
...
CREATE TABLE IF NOT EXISTS ingestion_run (
  ...
  collector_source VARCHAR(20) NOT NULL DEFAULT 'GENERAL' COMMENT 'GENERAL/BUSINESS/PERSONAL/IMAGE',
...
--   WHEN source_type IN ('LIST_API', 'LIST_GENERAL') THEN 'LIST_GENERAL'
